{
    ...
    'version': '1.0.0',
    'author': 'Marcella',
    'summary': 'Melihat KHS Mahasiswa UKP', #deskripsi singkat dari modul
    'description': 'Modul nilai', #bisa nampilkan gambar/ deskripsi dalam bentuk html. html diletakkan
