...
class detail(models.Model):
    ...
    orders_id = fields.Many2one('restaurant.orders', string='ID Orders', readonly=False, ondelete="cascade", states={'draft': [('readonly', False)]}, domain="[('state', '=', 'done')]")
    bukumenu_id = fields.Many2one('restaurant.bukumenu', string='Buku Menu', readonly=False, ondelete="cascade", states={'draft': [('readonly', False)]}, domain="[('state', '=', 'done')]")
